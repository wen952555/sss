...
def run(playwright):
    ...
    try:
        ...
        # Verify that we are in the game table
        expect(page.locator("h1:has-text('局 - 玩家:')")).to_be_visible(timeout=10000)

        # Take a screenshot of the game table
        page.screenshot(path="jules-scratch/verification/direct_game_entry.png")

    except Exception as e:
        page.screenshot(path="jules-scratch/verification/direct_game_entry_error.png")
        raise e
    finally:
        browser.close()
