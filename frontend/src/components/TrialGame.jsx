...
const TrialGame = () => {
    ...
    const handleCardClick = (clickedCard, clickedHandName) => {
        ...
        const newArrangedHands = JSON.parse(JSON.stringify(arrangedHands));
        ...
        sourceHand.splice(cardA_index, 1, clickedCard);
        targetHand.splice(cardB_index, 1, selectedCard.card);
