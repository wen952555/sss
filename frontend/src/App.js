    ...
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="app-container">
        ...
        <ComparisonModal 
            ...
            onContinueGame={() => {setShowComparisonModal(false); /* 提示用户点重新发牌 */}}
            players={players}
